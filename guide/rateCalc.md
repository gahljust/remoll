...
We can now take the integral of this histogram. But what we get is still not the rate at this detector. $$\int\frac{dN_{300}}{dr}dr = 3.06e12$$
...
Putting this together, we get:$$\text{Rate} = 1938*6.24e12 / 99.92e6 = \boxed{121.0 \frac{\text{MHz}}{1\mu A}}$$
